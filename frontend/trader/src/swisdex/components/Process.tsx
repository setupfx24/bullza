      ...
      >
        <div className="flex flex-col items-start gap-5 mb-14 md:mb-20">
          ...
          <p className="font-body text-foreground/60 max-w-2xl">
            SwisDex is a leading AI-driven cryptocurrency and forex investment company. From sign-up to first profit in four simple steps — whether you are a first-time investor or a seasoned trader.
          </p>
        </div>
