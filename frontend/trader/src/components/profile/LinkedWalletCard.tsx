  ...
  return (
    <div className="bg-card-base border border-border-glass/30 rounded-xl p-4 md:p-5">
      <div className="flex items-start gap-3 mb-3">
        <div className="w-9 h-9 rounded-lg bg-[#E12019]/15 flex items-center justify-center shrink-0">
          <Wallet size={16} className="text-[#E12019]" />
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-bg-secondary border border-border-primary">
            ...
            <button
              type="button"
              onClick={handleCopy}
              className="ml-auto inline-flex items-center gap-1 text-[11px] text-text-tertiary hover:text-[#E12019] transition-colors"
