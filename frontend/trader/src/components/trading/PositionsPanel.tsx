        ...
        <div className="text-right shrink-0">
          <div
            className={clsx(
              ...
              pnl >= 0
                ? 'bg-green-500/10 border-green-500/20 text-[#E12019]'
          ...
          <div className="text-[11px] font-mono font-semibold tabular-nums inline-flex items-center justify-end gap-0.5 text-text-primary leading-tight">
            ...
            {cur != null &&
              (priceDown ? (
                ...
                <TrendingUp className="w-3 h-3 text-[#E12019]" aria-hidden />
              ))}
          </div>
        </div>
      </div>
                    ...
                    <div className="flex flex-col items-end gap-0.5 shrink-0">
                      ...
                      <span
                        className={clsx(
                          ...
                          totalPnl >= 0 ? 'text-[#E12019]' : 'text-[#ef5350]',
                        )}
                      >
                ...
                {tabs.map((tab) => (
                  <button
                    ...
                    className={clsx(
                      ...
                      activeTab === tab.id
                        ? clsx('text-text-primary border-[#E12019]', 'bg-bg-secondary/70')
                        : clsx(
