  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        disabled={disabled}
        className="w-full pl-9 pr-3 py-2.5 rounded-lg border border-border-primary bg-bg-secondary text-text-primary outline-none focus:border-[#E12019]/50 text-sm text-left disabled:opacity-60"
