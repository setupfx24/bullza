        ...
        <>
          ...
          {!wrongNetwork && (
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-md bg-[#E85D3D] text-bg-base text-sm font-bold disabled:opacity-60"
            >
          ...
          {txHash && explorerUrl && (
            <a
              ...
              className="inline-flex items-center gap-1 text-[11px] text-text-tertiary hover:text-[#E85D3D]"
            >
