        ...
        <>
          ...
          {!wrongNetwork && (
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-md bg-[#E12019] text-bg-base text-sm font-bold disabled:opacity-60"
            >
          ...
          {txHash && explorerUrl && (
            <a
              ...
              className="inline-flex items-center gap-1 text-[11px] text-text-tertiary hover:text-[#E12019]"
            >
