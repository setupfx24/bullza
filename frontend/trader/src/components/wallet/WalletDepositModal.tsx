      ...
      >
        ...
        <div className="px-6 pt-6 pb-3 border-b border-border-primary">
          <h2 className="text-base font-semibold text-text-primary flex items-center gap-2">
            <Wallet size={16} className="text-[#E12019]" /> Crypto deposit
          </h2>
...
function DepositBody({
    ...
    return (
      <div className="px-6 py-10 text-center space-y-3">
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-2 px-5 py-2 rounded-md bg-[#E12019] text-bg-base text-sm font-bold"
        >
          Done
        </button>
      </div>
  ...
  return (
    <div className="px-6 py-5 space-y-4">
      <div className="flex items-center gap-3 p-3 rounded-lg bg-[#E12019]/5 border border-[#E12019]/25">
...
function Countdown({ deposit, expired }: { deposit: CreatedDeposit; expired: boolean }) {
  ...
  return (
    <p className="text-[11px] text-text-tertiary flex items-center gap-1.5">
      <Clock size={11} className="text-[#E12019]" /> Payment window: {remaining}
    </p>
  );
}
