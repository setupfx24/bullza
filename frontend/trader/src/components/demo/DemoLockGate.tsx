...
export default function DemoLockGate({ feature, description, children }: Props) {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-4 sm:p-8">
      ...
      >
        <div className="mx-auto w-14 h-14 rounded-full bg-[#E12019]/15 border border-[#E12019]/30 flex items-center justify-center mb-4">
          <Lock className="w-6 h-6 text-[#E12019]" strokeWidth={2.2} />
        </div>
        ...
        <div className="mt-5 flex flex-col sm:flex-row gap-2 justify-center">
          <Link
            href="/auth/register"
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-[#E12019] text-white text-sm font-bold hover:bg-[#B31810] transition-colors shadow-[0_2px_8px_rgba(225, 32, 25,0.25)]"
          >
