      ...
      <div className="space-y-5 pb-8">
        <header>
          <h1 className="text-2xl md:text-3xl font-bold text-text-primary tracking-tight flex items-center gap-2">
            Play Zone <Sparkles size={22} className="text-[#E85D3D]" />
          </h1>
...
function ActiveCard({
  ...
  return (
    <Link
      href={href}
      className="group rounded-xl border border-[#E85D3D]/35 bg-gradient-to-br from-[#E85D3D]/10 via-bg-secondary to-bg-secondary p-5 hover:border-[#E85D3D]/65 transition-colors"
    >
      <div className="flex items-center justify-between">
        <Icon size={22} className="text-[#E85D3D]" />
      ...
      <h3 className="text-base font-semibold text-text-primary mt-3 flex items-center gap-1.5">
        {title}
        <ArrowRight size={14} className="text-text-tertiary group-hover:text-[#E85D3D] group-hover:translate-x-0.5 transition-transform" />
      </h3>
