              ...
              {(
                ...
                return (
                  ...
                  >
                    ...
                    {active ? (
                      <span className="relative inline-block animate-wallet-main-tab-text drop-shadow-[0_0_20px_rgba(225, 32, 25,0.7)]">
                        {label}
                      </span>
                    ) : (
                  ...
                  <div className="flex border-b border-border-primary mb-4 overflow-x-auto">
                    {dayTabs.map((tab) => (
                      ...
                      >
                        {tab.label}
                        {dayTab === tab.id && (
                          <span className="absolute bottom-0 left-2 right-2 h-0.5 rounded-full bg-accent shadow-[0_0_10px_rgba(225, 32, 25,0.5)]" />
                        )}
                      </button>
                    ))}
                  </div>
