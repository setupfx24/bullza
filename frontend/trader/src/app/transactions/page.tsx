      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
        <div className="w-full max-w-[1600px] mx-auto px-3 sm:px-6 lg:px-10 py-4 sm:py-6 pb-24 space-y-5 sm:space-y-6">
          <div className="flex items-start justify-between gap-3">
            ...
            {mainTab === 'transactions' && (
              <div className="flex items-center gap-2 shrink-0">
                ...
                >
                  <Download className="w-4 h-4 text-[#E12019]" />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
            ...
            >
              <div className="absolute top-0 right-0 w-20 h-20 rounded-bl-[50px] bg-[#E12019]/[0.04] pointer-events-none" />
              <div className="relative flex items-center gap-3">
                <div
                  className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0 border border-[#E12019]/25"
                  style={{ background: 'linear-gradient(135deg, rgba(225, 32, 25,0.2) 0%, rgba(225, 32, 25,0.06) 100%)' }}
                >
                  <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-[#E12019]" strokeWidth={2} style={{ filter: 'drop-shadow(0 0 6px rgba(225, 32, 25,0.5))' }} />
                </div>
                <div className="min-w-0">
                  <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-[#E12019]/60">Total Deposits</p>
            ...
            >
              <div className="absolute top-0 right-0 w-20 h-20 rounded-bl-[50px] bg-[#E12019]/[0.03] pointer-events-none" />
              <div className="relative flex items-center gap-3">
                <div
                  className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg sm:rounded-xl flex items-center justify-center shrink-0 border border-[#E12019]/20"
                  style={{ background: 'linear-gradient(135deg, rgba(225, 32, 25,0.15) 0%, rgba(225, 32, 25,0.04) 100%)' }}
                >
                  <DollarSign className="w-4 h-4 sm:w-5 sm:h-5 text-[#E12019]" strokeWidth={2} style={{ filter: 'drop-shadow(0 0 6px rgba(225, 32, 25,0.4))' }} />
                </div>
                <div className="min-w-0">
                  <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-[#E12019]/50">IB Commissions</p>
              ...
              {(['all', 'completed', 'pending', 'failed'] as const).map((s) => (
                <button
                  ...
                  className={clsx(
                    ...
                    statusFilter === s
                      ? s === 'completed'
                        ? 'bg-[#E12019]/15 text-[#E12019] border-[#E12019]/30'
                        : s === 'pending'
