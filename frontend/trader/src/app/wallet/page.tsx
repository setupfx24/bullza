    ...
    return (
      <DashboardShell mainClassName="flex items-center justify-center">
        <div className="flex flex-col items-center gap-3 py-12">
          <div className="w-8 h-8 border-2 border-[#E12019] border-t-transparent rounded-full animate-spin" />
        ...
        <div className="w-full max-w-full space-y-4 sm:space-y-6 px-2.5 sm:px-4 py-3 sm:py-4 pb-24 md:px-6 md:py-6">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3 md:gap-4">
              ...
              >
                <div className="absolute top-0 right-0 w-24 h-24 rounded-bl-[60px] bg-[#E12019]/[0.04] group-hover:bg-[#E12019]/[0.08] transition-colors duration-500" />
                <div className="relative p-3 sm:p-4 md:p-5 flex flex-col gap-2.5 sm:gap-3">
                  <div className="flex items-center justify-between">
                    <div
                      className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg sm:rounded-xl flex items-center justify-center border border-[#E12019]/25"
                      style={{ background: 'linear-gradient(135deg, rgba(225, 32, 25,0.18) 0%, rgba(225, 32, 25,0.05) 100%)' }}
                    >
                      <WalletIcon className="h-4 w-4 sm:h-5 sm:w-5 text-[#E12019]" strokeWidth={2} style={{ filter: 'drop-shadow(0 0 6px rgba(225, 32, 25,0.5))' }} />
                    </div>
                  ...
                  <div>
                    <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-[#E12019]/60 mb-0.5 sm:mb-1">Main Wallet</p>
                    ...
                    {(wallet?.main_wallet_bonus ?? 0) > 0 && (
                      <div className="mt-1.5 pt-1.5 border-t border-[#E12019]/10">
                  ...
                  {liveAccounts.length > 0 && (
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-1.5 rounded-xl py-2.5 text-[11px] font-bold transition-all bg-[#E12019]/10 text-[#E12019] border border-[#E12019]/20 hover:bg-[#E12019]/20 hover:border-[#E12019]/40 disabled:opacity-40 disabled:pointer-events-none"
                    >
              ...
              {liveAccounts.map((a) => {
                ...
                const cardLabel = num.startsWith('IF') ? 'PAMM Investment'
                  ...
                  : num;
                const ac = isManaged ? { r: '245,158,11', hex: '#f59e0b' } : isPool ? { r: '168,85,247', hex: '#a855f7' } : { r: '225,32,25', hex: '#E12019' };
                ...
                return (
                  ...
                  >
                    {active ? (
                      <span
                        key={fundMainTab}
                        className="relative inline-block animate-wallet-main-tab-text drop-shadow-[0_0_20px_rgba(225, 32, 25,0.7)]"
                      >
              ...
              {fundMainTab === 'deposit' ? (
                <>
                  ...
                  <div>
                    ...
                    <button
                      type="button"
                      className="w-full py-3.5 rounded-xl bg-[#E12019] text-white font-bold text-sm flex items-center justify-center gap-2"
                    >
                    ...
                    <>
                      ...
                      <div className="rounded-xl border border-border-primary bg-bg-secondary px-3 py-3 sm:px-4 space-y-2 min-w-0">
                                ...
                                <p className="break-all sm:col-span-2">
                                  ...
                                  <span className="inline-flex items-center gap-2">
                                    ...
                                    <button
                                      ...
                                      className="text-[10px] font-sans font-semibold text-[#E12019] hover:underline"
                                    >
                                      Copy
                                    </button>
                                  </span>
                        ...
                        <button
                          ...
                          className="text-[10px] font-semibold text-[#E12019] hover:underline"
                        >
                      ...
                      <div className="space-y-1 min-w-0">
                        ...
                        >
                          ...
                          />
                          {depositProofFile ? (
                            <span className="text-sm font-medium text-[#E12019] px-2 text-center">{depositProofFile.name}</span>
                          ) : (
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <button
                            ...
                            className="text-xs font-bold text-[#E12019] hover:underline"
                          >
                            Max
                          </button>
                        </div>
                    ...
                    <>
                      ...
                      <div className="space-y-1">
                        ...
                        >
                          ...
                          />
                          {manualWithdrawQrFile ? (
                            <span className="text-sm font-medium text-[#E12019] px-2 text-center">
          ...
          <section id="bonus" className="scroll-mt-24 space-y-3">
            ...
            <div className="rounded-xl border border-border-glass/30 bg-bg-secondary/40 p-4">
              <p className="text-xxs font-bold uppercase tracking-wide text-[#E12019] mb-2">Active offers</p>
                ...
                <ul className="space-y-2">
                  {bonusOverview.active_offers.map((o) => (
                    ...
                    >
                      ...
                      <span className="shrink-0 text-[10px] font-bold uppercase tracking-wider text-[#E12019] bg-[#E12019]/10 border border-[#E12019]/25 rounded-full px-2 py-0.5">
                        {o.bonus_type || 'bonus'}
                      </span>
                    </li>
                  ))}
            ...
            <div className="rounded-xl border border-border-glass/30 bg-bg-secondary/40 p-4">
              <p className="text-xxs font-bold uppercase tracking-wide text-[#E12019] mb-2">My bonus requests</p>
            ...
            <div className="rounded-xl border border-border-glass/30 bg-bg-secondary/40 p-4">
              <p className="text-xxs font-bold uppercase tracking-wide text-[#E12019] mb-2">My bonus history</p>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md rounded-2xl border border-border-primary bg-bg-base shadow-2xl p-5 sm:p-6 space-y-4 animate-in fade-in zoom-in-95">
            ...
            <ul className="space-y-2.5 text-xs text-text-secondary">
              <li className="flex gap-2"><span className="text-[#E12019] font-bold">•</span><span>Pay the <strong className="text-text-primary">exact amount</strong> requested — a different amount may delay or block crediting.</span></li>
              ...
              <li className="flex gap-2"><span className="text-[#E12019] font-bold">•</span><span>UPI deposits may take up to <strong className="text-text-primary">20 minutes</strong> to credit. If it takes longer, contact live support.</span></li>
            </ul>
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button
                ...
                className="flex-1 py-2.5 rounded-xl bg-[#E12019] text-sm font-bold text-white hover:bg-[#4a9329] transition-fast disabled:opacity-50"
              >
                Confirm &amp; Submit
              </button>
            </div>
