...
const TIERS = [
  ...
  { tier: 'Elite',    cover: '50%', cap: '$1,000', tone: '#E85D3D' },
];
  ...
  return (
    <main className="relative overflow-hidden" style={{ background: 'var(--fx-bg)' }}>
      ...
      <section className="fx-container relative z-10 pt-28 md:pt-36 pb-16">
        <p className="text-xs uppercase tracking-[0.25em] text-[#E85D3D]/85 mb-3">Trade Insurance</p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/auth/register" className="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-[#E85D3D] text-bg-base font-bold text-sm hover:brightness-110">
            Activate Protection <ArrowRight size={14} />
          </Link>
          <Link href="/insurance" className="inline-flex items-center gap-2 px-5 py-3 rounded-lg border border-[#E85D3D]/40 text-text-primary text-sm hover:border-[#E85D3D]/70">
            View My Policies
          </Link>
        </div>
      </section>
      ...
      <section className="fx-container relative z-10 py-20">
        <div className="rounded-2xl border border-[#E85D3D]/30 p-10 md:p-14 text-center bg-[rgba(232, 93, 61,0.04)]">
          <ShieldCheck size={28} className="text-[#E85D3D] mx-auto mb-4" />
