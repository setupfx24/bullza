...
const SECTIONS = [
  ...
  {
    h: '7. AI Powered Setting Plans',
    p: `AI Powered Setting ("APS") plans pay a contractual yield at maturity, underwritten by
    independent regulated insurance counterparties. Capital protection at maturity is subject to
    the underwriter's continuing solvency and the policy terms. APS plans are NOT bank deposits
