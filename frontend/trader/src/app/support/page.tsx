              ...
              <div className="px-3 py-2 border-b border-border-glass flex items-center gap-2">
                ...
                {SUPPORT_EMAIL && (
                  ...
                  <a
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-1.5 px-2.5 py-1.5 rounded-md border border-[#E12019]/25 bg-[#E12019]/5 hover:bg-[#E12019]/10 transition-colors text-xs font-medium text-text-primary"

                    title={`Email ${SUPPORT_EMAIL}`}

                  >

                    <Mail size={13} className="text-[#E12019]" />
