...
const phaseMeta = [
  { icon: '◆', border: 'border-[#E85D3D]/30', bg: 'bg-[#E85D3D]/10' },
  { icon: '●', border: 'border-[#E85D3D]/30', bg: 'bg-[#E85D3D]/10' },
  { icon: '◉', border: 'border-[#E85D3D]/30', bg: 'bg-[#E85D3D]/10' },
    ...
    <DashboardShell>
      <div className="page-main max-w-6xl mx-auto w-full pb-8">
        <div className="text-center mb-8">
          <div className="inline-block px-4 py-1.5 rounded-full border border-[#E85D3D]/30 text-[#E85D3D] text-xs font-medium tracking-wider uppercase mb-4">
            ● CURRICULUM
          </div>
          ...
          <p className="text-[#E85D3D] text-sm tracking-widest uppercase">MASTER FOREX TRADING FROM BEGINNER TO PROFESSIONAL</p>
          ...
          <div className="text-center mb-4">
            ...
            <div className="h-2 max-w-md mx-auto mt-3 rounded-full bg-bg-secondary overflow-hidden border border-border-primary">
              <div className="h-full bg-[#E85D3D] rounded-full transition-all" style={{ width: `${pct}%` }} />
            </div>
          </div>
              ...
              <div key={phase.id} className="text-center">
                <div
                  className={clsx(
                    ...
                    i === 0 ? 'border-[#E85D3D] text-[#E85D3D]' : 'border-border-secondary text-text-tertiary',
                  )}
                >
                  {i + 1}
                </div>
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <ArrowRight size={16} className="text-text-tertiary group-hover:text-[#E85D3D] transition-colors" />
                  </div>
                </div>
