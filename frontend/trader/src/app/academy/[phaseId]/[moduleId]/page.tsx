    ...
    return (
      <DashboardShell>
        <div className="page-main max-w-4xl mx-auto text-center py-20">
          ...
          <Link href="/academy" className="text-[#E12019] hover:underline text-sm mt-2 inline-block">
            ← Back to Academy
          </Link>
        </div>
      </DashboardShell>
    ...
    <DashboardShell>
      <div className="page-main max-w-6xl mx-auto w-full pb-8">
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-sm text-text-secondary hover:text-[#E12019] transition-colors mb-6 px-4 py-2 rounded-lg border border-border-glass hover:border-[#E12019]/30"
        >
          <ArrowLeft size={14} />
          BACK TO {phase.title}
        </Link>
          ...
          {phase.modules.map((m, i) => (
            <Link
              ...
              className={clsx(
                ...
                m.id === moduleId
                  ? 'border-[#E12019] bg-[#E12019]/10 text-[#E12019]'
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-xs px-2.5 py-1 rounded bg-[#E12019]/10 text-[#E12019] font-bold border border-[#E12019]/20">
              MODULE {module.id}
            </span>
          ...
          <div className="w-12 h-0.5 bg-[#E12019]" />
        </div>
          ...
          <>
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                type="button"
                onClick={toggleAll}
                className="text-xs text-[#E12019] hover:underline font-medium uppercase tracking-wider"
              >
              ...
              {content.topics.map((topic) => {
                ...
                return (
                  <div key={topic.id} className="bg-bg-secondary border border-border-glass rounded-xl overflow-hidden">
                    ...
                    >
                      <span
                        className="w-8 h-8 rounded-full border-2 border-[#E12019]/30 flex items-center justify-center text-xs font-bold shrink-0"
                      ...
                      {isOpen ? (
                        <ChevronDown size={16} className="text-[#E12019] shrink-0" />
                      ) : (
                      ...
                      <div className="px-5 pb-5 border-t border-border-glass">
                        <div className="flex items-center justify-between mt-4 mb-3">
                          <div className="flex items-center gap-2">
                            <div className="w-6 h-0.5 bg-[#E12019]" />
                            <span className="text-[10px] uppercase tracking-widest text-[#E12019] font-medium">
                              LESSON CONTENT
                            </span>
                          </div>
                        ...
                        <div className="space-y-4">
                          {topic.blocks.map((block: TopicBlock, bi: number) => {
                            if (block.type === 'definition') {
                              return (
                                <div key={bi} className="border-l-2 border-[#E12019] bg-[#E12019]/5 rounded-r-lg p-4">
                                  <div className="flex items-center gap-1.5 mb-2">
                                    <BookOpen size={12} className="text-[#E12019]" />
                                    <span className="text-[10px] uppercase tracking-widest text-[#E12019] font-bold">DEFINITION</span>
                                  </div>
                            ...
                            if (block.type === 'keyConcept') {
                              return (
                                <div key={bi} className="border-l-2 border-[#E12019] bg-[#E12019]/5 rounded-r-lg p-4">
                                  <div className="flex items-center gap-1.5 mb-2">
                                    <KeyRound size={12} className="text-[#E12019]" />
                                    <span className="text-[10px] uppercase tracking-widest text-[#E12019] font-bold">KEY CONCEPT</span>
                                  </div>
                                  <p className="text-sm text-text-secondary leading-relaxed">{block.content}</p>
                                </div>
                              );
                            ...
                            if (block.type === 'practiceTip') {
                              return (
                                <div key={bi} className="bg-bg-secondary border border-border-glass rounded-xl p-4">
                                  <div className="flex items-center gap-1.5 mb-2">
                                    <Lightbulb size={12} className="text-[#E12019]" />
                                    <span className="text-[10px] uppercase tracking-widest text-[#E12019] font-bold">PRACTICE TIP</span>
                                  </div>
                                  <p className="text-sm text-text-secondary leading-relaxed">{block.content}</p>
                                </div>
                              );
                              ...
                              return (
                                <div key={bi}>
                                  <div className="flex items-center gap-2 mb-3">
                                    <div className="w-6 h-0.5 bg-[#E12019]" />
                                    <span className="text-[10px] uppercase tracking-widest text-[#E12019] font-bold">{block.content}</span>
                                  </div>
                                    ...
                                    {block.timelineData.map((item, ti) => (
                                      <div key={ti} className="flex gap-4">
                                        <div className="flex flex-col items-center">
                                          <div className="w-8 h-8 rounded-full bg-[#E12019]/10 border border-[#E12019]/30 flex items-center justify-center text-sm shrink-0">
                                            {item.icon}
                                          </div>
                                        ...
                                        <div className="pb-4 min-w-0">
                                          <div className="flex items-center gap-2 mb-0.5">
                                            <span className="text-[10px] font-bold text-[#E12019] uppercase tracking-wider">{item.year}</span>
                                  ...
                                  <div className="space-y-0">
                                    {block.hierarchyData.map((h, hi) => (
                                      <div key={hi} className="flex gap-3">
                                        <div className="flex flex-col items-center">
                                          <div className="w-8 h-8 rounded-full bg-[#E12019]/10 border border-[#E12019]/20 flex items-center justify-center text-sm shrink-0">
                                            {h.icon}
                                          </div>
                                          {hi < block.hierarchyData!.length - 1 && (
                                            <div className="w-px flex-1 border-l border-dashed border-[#E12019]/20 my-1" />
                                          )}
                                        </div>
                                        <div className="pb-3">
            ...
            <div className="border-l-2 border-[#E12019] bg-bg-secondary rounded-r-xl p-5 mb-6">
              <h3 className="text-[11px] uppercase tracking-widest text-[#E12019] font-bold mb-3">KEY TAKEAWAYS</h3>
              <div className="space-y-2">
                {content.keyTakeaways.map((t, i) => (
                  <div key={i} className="flex items-start gap-2">
                    <CheckCircle size={14} className="text-[#E12019] mt-0.5 shrink-0" />
              ...
              <button
                ...
                className={clsx(
                  ...
                  isCompleted
                    ...
                    : 'bg-[#E12019] hover:bg-[#B31810] text-white'
                )}
              >
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          {nextModule ? (
            ...
            <Link
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-[#E12019] text-sm text-[#E12019] hover:bg-[#E12019]/10 transition-colors"
            >
              TAKE QUIZ
              <ArrowRight size={14} />
            </Link>
