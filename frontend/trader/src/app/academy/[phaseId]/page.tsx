  ...
  return (
    <DashboardShell>
      <div className="page-main max-w-6xl mx-auto w-full pb-8">
        <Link
          href="/academy"
          className="inline-flex items-center gap-1.5 text-sm text-text-secondary hover:text-[#E85D3D] transition-colors mb-5"
        >
          <ArrowLeft size={14} />
          ALL PHASES
        </Link>
                ...
                <span
                  className={clsx(
                    ...
                    phase.level === 'BEGINNER'
                      ? 'bg-[#E85D3D]/10 text-[#E85D3D] border-[#E85D3D]/20'
                  ...
                  <div key={module.id}>
                    <Link
                      ...
                      className={clsx(
                        ...
                        isDone
                          ? 'bg-[#E85D3D]/5 border-[#E85D3D]/20 hover:border-[#E85D3D]/40'
                    ...
                    >
                      <div
                        className={clsx(
                          ...
                          isDone ? 'bg-[#E85D3D]/10 border-[#E85D3D] text-[#E85D3D]' : 'border-border-secondary text-text-tertiary',
                        )}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {isDone && (
                            <span className="text-[9px] px-1.5 py-0.5 rounded bg-[#E85D3D]/10 text-[#E85D3D] font-bold border border-[#E85D3D]/20 uppercase tracking-wider">
                              DONE
                            </span>
                          )}
                        </div>
                      ...
                      <ArrowRight size={16} className="text-text-tertiary group-hover:text-[#E85D3D] transition-colors shrink-0" />
                    </Link>
        ...
        {phase.quiz && phase.modules.length > 0 && (
          <div className="mt-6 bg-bg-secondary border border-[#E85D3D]/20 rounded-xl p-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <p className="text-[10px] uppercase tracking-widest text-[#E85D3D] font-medium mb-1">KNOWLEDGE CHECK</p>
                ...
                <div className="flex items-center gap-3 mt-2">
                  <div className="w-32 h-1.5 bg-bg-tertiary rounded-full overflow-hidden">
                    <div className="h-full bg-[#E85D3D] rounded-full" style={{ width: '0%' }} />
                  </div>
              ...
              <Link
                ...
                className="px-4 py-2 rounded-lg bg-[#E85D3D] hover:bg-[#C9482D] text-white text-sm font-semibold transition-colors text-center whitespace-nowrap"
              >
                Start Quiz
              </Link>
            </div>
