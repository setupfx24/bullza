              ...
              {(isNotStarted || isRejected) && (
                <div className="p-8 md:p-10 text-center space-y-5">
                  ...
                  <button
                    type="button"
                    onClick={openForm}
                    className="inline-flex items-center justify-center gap-2 w-full sm:w-auto min-w-[240px] px-8 py-3.5 rounded-xl text-sm font-bold border-2 border-accent bg-accent text-black hover:brightness-110 transition-all shadow-[0_0_24px_rgba(225, 32, 25,0.35)]"
                  >
          ...
          <div className="relative w-full sm:max-w-lg max-h-[92dvh] overflow-y-auto rounded-t-2xl sm:rounded-2xl border border-border-primary bg-card shadow-2xl sidebar-scroll">
            ...
            <div className="p-5 space-y-5">
              ...
              <button
                ...
                disabled={submitting}
                className="w-full py-3.5 rounded-xl border-2 border-accent bg-accent hover:brightness-110 disabled:opacity-60 text-black font-bold text-sm transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(225, 32, 25,0.25)]"
              >
                {submitting ? (
                  <>
