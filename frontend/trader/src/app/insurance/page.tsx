      ...
      <div className="space-y-5 pb-8">
        <div className="flex items-start justify-between gap-3 flex-wrap">
          <h1 className="text-2xl font-bold text-text-primary tracking-tight flex items-center gap-2">
            <ShieldCheck size={22} className="text-[#E12019]" /> Trade Insurance
          </h1>
          <button
            type="button"
            onClick={() => {
            ...
            className="text-xs text-text-tertiary hover:text-text-primary inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md border border-border-primary hover:border-[#E12019]/40"
          >
          ...
          <>
            ...
            <section className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <Stat
                ...
                tone={pendingClaims.length > 0 ? 'text-[#E12019]' : 'text-text-secondary'}
              />
              <Stat
                label="Total Claimed"
                    ...
                    <li key={c.id} className="py-3 flex items-center gap-3 flex-wrap">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-semibold text-text-primary truncate">
                          ...
                          <span className="text-[#E12019]">{formatTier(c.tier)}</span>
                        </p>
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-semibold bg-[#E12019] hover:bg-[#B31810] text-white disabled:opacity-60 disabled:cursor-wait transition-colors"
                      >
                        {claimingId === c.id ? (
                          <>
                      ...
                      <li key={p.id} className="py-3 flex items-start gap-3 flex-wrap">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-sm font-semibold text-text-primary truncate">
                            {p.instrument_symbol || '—'}{' '}
                            <span className="text-text-tertiary">·</span>{' '}
                            <span className="text-[#E12019]">{formatTier(p.tier)}</span>
                          </p>
  ...
  return (
    <div
      ...
      style={{
        ...
        border: accent ? '1px solid #E1201980' : '1px solid var(--border-primary)',
        boxShadow: accent ? '0 0 0 1px #E1201922 inset' : undefined,
      }}
    >
