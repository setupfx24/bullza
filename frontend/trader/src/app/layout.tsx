...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [{ url: '/images/swisdex_logo_fevicon.png', type: 'image/png' }],
  },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <link rel="icon" href="/images/swisdex_logo_fevicon.png" type="image/png" />
        <link rel="apple-touch-icon" href="/images/swisdex_logo_fevicon.png" />
        <script
