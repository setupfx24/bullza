            ...
            <ScrollReveal variant="fadeRight" delay={0.2}>
              <div className="glass-card overflow-hidden">
                <div className="aspect-video rounded-t-lg overflow-hidden">
                  <img src="/images/swisdex-logo.png" alt="SwisDex Web Platform" className="w-full h-full object-contain p-16 bg-gradient-to-br from-primary-bg to-primary-secondary" />
                </div>
                <div className="p-8">
