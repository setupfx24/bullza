    ...
    <div className="min-h-screen pt-20">
      <section className="section-padding hero-banner relative overflow-hidden" style={{ background: '#050707' }}>
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(60% 50% at 50% 0%, rgba(225, 32, 25,0.18) 0%, transparent 60%), ' +
        ...
        <div className="container-custom text-center relative z-10">
          <ScrollReveal variant="fadeUp">
            <span
              ...
              style={{
                background: 'rgba(225, 32, 25,0.18)',
                border: '1px solid rgba(225, 32, 25,0.4)',
              }}
            >
              <span className="size-1.5 rounded-full" style={{ background: '#E12019' }} />
