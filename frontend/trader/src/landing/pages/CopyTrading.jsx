...
const steps = [
  { step: '01', title: 'Open an Account', desc: 'Register and fund your SwisDex trading account.' },
          ...
          <div className="glass-card p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <ScrollReveal variant="fadeLeft">
                <h2 className="text-3xl font-bold text-white mb-4">Why Copy Trade with SwisDex?</h2>
