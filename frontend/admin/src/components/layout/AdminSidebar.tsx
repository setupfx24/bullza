  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center h-14 px-3 border-b border-border-primary/40">
        {collapsed ? (
          <img src="/images/swisdex_fevicon1.png" alt="SwisDex" className="w-7 h-7 object-contain mx-auto" />
        ) : (
          <Link href="/" className="flex items-center gap-2 min-w-0">
            <img src="/images/swisdex_fevicon1.png" alt="SwisDex" className="w-7 h-7 object-contain shrink-0" />
